...
const blogArtical = () => {
  return (
    <div className="container mx-auto px-10">
      ...
      <div className="mt-28">
        <span className="rounded-sm bg-blue-900 text-white">View blog Articles <span className="font-semibold"><IonIcon name="chevron-forward-circle-outline" /></span></span>
      </div>
    </div>
  )
}
